...
--ALTER TABLE "public"."Customer" ADD CONSTRAINT "CK_Customer_VatId" CHECK ((char_length("VatId")=(0) OR ("IsNaturalPerson"=(0) AND (len("VatId")=(10) OR ("IsNaturalPerson"=(1) AND len("VatId")=(12))))));
...
ALTER TABLE "public"."PollConnection" ADD CONSTRAINT "CK_PollConnection_GprsCallType_DialNumber" CHECK (("GprsCallType"=(0) OR char_length("DialNumber")>(0)));
...
ALTER TABLE "public"."Version" ADD CONSTRAINT "CK_Version_Version" CHECK (char_length("Version")>(0));
